...
RMSE: computeRMSE.cpp matmethods.hpp h5objcpp.hpp
	g++ -std=c++11 -O3 -g computeRMSE.cpp -fopenmp  -o RMSE -I/usr/local/include -I/usr/local/boost_1_47_0 -L/usr/local/lib -I/home/nwk2/include -L/home/nwk2/lib -L/home/nwk2/usr/lib64 -I/home/nwk2/usr/include -larmadillo -lhdf5_cpp -lhdf5_hl_cpp -lssl -lcrypto -lhdf5	
...
Gen_Submat: generate_submat.cpp matmethods.hpp
	g++ -std=c++11 -O3 -g generate_submat.cpp -o Gen_Submat -I/usr/local/include -I/usr/local/boost_1_47_0 -L/usr/local/lib -I/home/nwk2/include -L/home/nwk2/lib -L/home/nwk2/usr/lib64 -I/home/nwk2/usr/include -larmadillo -lhdf5_cpp -lhdf5_hl_cpp -lssl -lcrypto -lhdf5
